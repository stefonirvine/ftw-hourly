...
const EMPLOYER_COMMISSION_PERCENTAGE = -17;
...
const quantity = calculateQuantityFromDates(startDate, endDate, unitType);
  ...
  const employerCommission = {
    code: 'line-item/employer-commission',
    unitPrice: calculateTotalFromLineItems([booking]),
    percentage: commissionPercentage,
    includeFor: ['provider', 'customer'],
  };
  const lineItems = [booking, employerCommission, providerCommission];
